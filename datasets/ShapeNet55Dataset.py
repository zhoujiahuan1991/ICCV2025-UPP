...
class ShapeNet(data.Dataset):
    def __init__(self, config):
        ...
        for line in lines:
            ...
            if os.path.exists(os.path.join(self.pc_path, line)):
        ...
        print_log(f'[DATASET] {len(missing_file_list)} instances were missing', logger = 'ShapeNet-55')
    ...
    def __getitem__(self, idx):
        ...
        return sample['taxonomy_id'], sample['model_id'], (data, self.label_map[sample['taxonomy_id']])
